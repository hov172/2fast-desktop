        ...
        private async Task ReadAuthenticationFromString()
        {
            ...
            switch (EntryEnum)
            {
                ...
                case AccountEntryEnum.Add:
                    if (_qrCodeStr.StartsWith("otpauth://", StringComparison.OrdinalIgnoreCase) || _qrCodeStr.StartsWith("mobileid://", StringComparison.OrdinalIgnoreCase) || _qrCodeStr.StartsWith("steam"))
                    {
