...
namespace Project2FA.Repository.Models
{
    ...
    public partial class TwoFACodeModel : ObservableObject, ICloneable
    {
        ...
        public string OcraSuite { get; set; } = string.Empty;
        public bool MobileIdChecksum { get; set; }
        [JsonConverter(typeof(EncryptedStringConverter))]
        public string MobileIdDeviceId { get; set; } = string.Empty;
        [JsonIgnore]
...
#if !WINDOWS_UWP
        [JsonIgnore]
        public Microsoft.UI.Xaml.Visibility OcraActionVisibility => IsOcraCapable ? Microsoft.UI.Xaml.Visibility.Visible : Microsoft.UI.Xaml.Visibility.Collapsed;
#endif
        ...
        public object Clone()
        {
            return new TwoFACodeModel {  
                ...
                SecretByteArray = SecretByteArray, OTPType = OTPType, OcraSuite = OcraSuite,
                Period = Period, HashMode = HashMode, TotpSize = TotpSize, MobileIdChecksum = MobileIdChecksum, MobileIdDeviceId = MobileIdDeviceId };
        }
    }
}
