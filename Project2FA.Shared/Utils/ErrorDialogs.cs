...
#else
            // BroadFileSystemAccess is a Windows capability. File I/O reports macOS access errors.
            var checkFileSystemAccess = AppCapabilityAccessStatus.Allowed;
#endif
...
#pragma warning disable AsyncFixer03 // Fire-and-forget async-void methods or delegates
                factoryResetBTN.Command = new RelayCommand(async () =>
                {
                    ...
                    selectedOption = true;
                    dialog.Hide();
                    await DataService.Instance.ResetMacOSSetup();
                    return;
#endif
