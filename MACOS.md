# 2fast 1.3.6 for macOS

The app is named **2fast**, version **1.3.6**, build **136**. Download
`2fast-macos-universal.zip` from the private repository's
[release page](https://github.com/hov172/2fast-desktop/releases/tag/v1.3.6).
...
[release notes](docs/RELEASE-v1.3.6.md).
