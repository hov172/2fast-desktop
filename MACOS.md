# 2fast 1.5.3 for macOS

The app is named **2fast**, version **1.5.3**, build **153**. Download
`2fast-macos-universal.dmg` from the private repository's
[release page](https://github.com/hov172/2fast-desktop/releases/tag/v1.5.3).
...
[release notes](docs/RELEASE-v1.5.3.md).
